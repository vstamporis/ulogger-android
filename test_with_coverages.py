...
command1_monkey = "gradlew.bat clean startMonkey --events=\"1500\" --throttle=\"200\" --epochs=\"30\" --config=\"" + config1 + "\""
...
command1 = "gradlew.bat clean startBaristaFuzzer --events=\"1500\" --throttle=\"200\" --epochs=\"30\" --config=\"" + config1 + "\""
